...
usb_data = [
    ['USB Hub BYEASY Leather Black', 13.99,
        'https://www.amazon.co.uk/gp/product/B07FH7XJCD/ref=sw_img_1?smid=A24ZEWS70EBJCV&psc=1'],
...
data = [mouse_data, kindle_data, alexa_data, stylist_data, usb_data]
